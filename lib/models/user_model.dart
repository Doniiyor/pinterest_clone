...
List<UsersModels> usersModelsFromJson(String str) => List.from(jsonDecode(str).map((e) => UsersModels.fromJson(e)));

String usersModelsToJson(List<UsersModels> data) => jsonEncode(List.from(data.map((e) => e.toJson())));
...
class User {
 ...
 static List categoryName = ["All", "Football", "Following", "Health", "Recipes"];
